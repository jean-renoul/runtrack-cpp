...
int main() {
    ...
    pingouin::ajouterLieuDeRencontre("lac");
    pingouin::ajouterLieuDeRencontre("glacier");
    pingouin::ajouterLieuDeRencontre("banquise");
    pingouin::afficherLieuxDeRencontres();
    pingouin::retirerLieuDeRencontre("glacier");
    pingouin::afficherLieuxDeRencontres();
